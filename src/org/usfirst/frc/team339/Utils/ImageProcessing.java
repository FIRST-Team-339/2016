...
public int getNumBlobs ()
{
    ...
    if (this.debugConsole == true)
        ...
        for (int i = this.reports.length - 1; i >= 0; i--)
            ...
            System.out
                    .println("Height: " + this.reports[i].imageHeight);
...
public boolean updateParticleAnalysisReports ()
{
    ...
    try
        ...
        NIVision.imaqColorThreshold(thresholdImage, this.image.image,
                255,
        ...
        if (this.objectRemoval == ObjectRemoval.SMALL)
            ...
            final NIVision.StructuringElement retStruct = new NIVision.StructuringElement(
                    3, 3, 0);
            NIVision.imaqSizeFilter(objectRemovalImage, convexHullImage,
                    0,
