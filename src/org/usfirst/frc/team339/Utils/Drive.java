 ...
 * @author Alex Kneipp
 */
public boolean alignByCamera (double percentageDeadBandX,
        ...
        if (this.cameraTimer.get() >= .50)
            ...
            try
                ...
                //if (Hardware.axisCamera.freshImage() == true)
                    {
                    if (Hardware.axisCamera.freshImage())
 ...
 * @author Alex Kneipp
 */
//TODO make this method sensible
public boolean alignByCamera (double percentageDeadBand,
        double correctionSpeed, double proportionalCenter)
{
    return alignByCamera(percentageDeadBand, percentageDeadBand,
            correctionSpeed,
            proportionalCenter, proportionalCenter, false);
}
...
private final double ROBOT_TURNING_RADIUS = 21.0;//12.0;
